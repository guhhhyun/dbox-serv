...
public interface ReqUseUsbMapper {
    public Optional<ReqUseUsb> selectOneByObjectId(@Param("rObjectId") String rObjectId);
    public List<ReqUseUsbApprovalListDto> selectReqUseUsbApprovList(@Param("uApprover") String uApprover);
}
