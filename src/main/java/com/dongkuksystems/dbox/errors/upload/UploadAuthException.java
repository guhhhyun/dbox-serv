...
public class UploadAuthException extends ServiceRuntimeException {
	private static final long serialVersionUID = -4540234967449872763L;

  private static final String MESSAGE_KEY = "error.uploadAuth";
  private static final String MESSAGE_DETAIL = "error.uploadAuth.details";

  public UploadAuthException(String message) {
