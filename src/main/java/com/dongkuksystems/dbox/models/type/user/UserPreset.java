...
public class UserPreset {
  ...
  private List<String> uLiveReadAuthorStrList;
  @ApiModelProperty(value = "live del 권한 list")
  private List<String> uLiveDeleteAuthorStrList;
  @ApiModelProperty(value = "closed read 권한 list")
  private List<String> uClosedReadAuthorStrList;

  @ApiModelProperty(value = "live read 권한 list")
  private List<AuthBase> uLiveReadAuthorList;
  @ApiModelProperty(value = "live read 권한 list")
  private List<AuthBase> uLiveDeleteAuthorList;
  @ApiModelProperty(value = "closed read 권한 list")
  private List<AuthBase> uClosedReadAuthorList;
