...
public class ProjectDetailDto {
  @ApiModelProperty(value = "프로젝트 id", required = true)
  private String rObjectId;
  @ApiModelProperty(value = "문서함코드", required = true)
  private String uCabinetCode;
  @ApiModelProperty(value = "프로젝트 코드", required = true)
  ...
  private List<VDept> joinDeptReads;
  @ApiModelProperty(value = "참여부서(편집/삭제) 리스트")
  private List<VDept> joinDeptDels;
}
