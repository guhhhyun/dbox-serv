...
@NoArgsConstructor
@Builder 
public class UserPresetDetailDto {
  ...
  @ApiModelProperty(value = "Live-읽기 권한자 List")
  //private List<String> liveRead;
  private List<UserPresetRepeatingDto> liveRead;
  @ApiModelProperty(value = "Live-삭제 권한자 List")
  private List<UserPresetRepeatingDto> liveDelete;
  @ApiModelProperty(value = "Closed 읽기 권한자 List")
  private List<UserPresetRepeatingDto> closedRead;
